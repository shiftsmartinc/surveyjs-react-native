...
export default class QuestionRadiogroup extends React.Component {
    ...
    render() {
        ...
        const generatedChoices = choices.length > 26
            ? choices
        ...
        {this.props.hasOther && (<View>
            <RadioItem value={OTHER_VALUE} text="Other" checked={this.props.value === OTHER_VALUE} onChange={this.handleChoicesChange}/>
            {this.props.value === OTHER_VALUE && (<QuestionText onChange={this.handleTextInputChange} value={this.props.comment} placeholder={otherText}/>)}
          </View>)}
      </View>);
    }
}
