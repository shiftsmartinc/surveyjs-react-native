...
let SurveyPage = class SurveyPage extends React.Component {
    ...
    render() {
        ...
        return (<KeyboardAwareScrollView ref={(ref) => { this.scrollView = ref; }} style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={true} enableOnAndroid>
        {currentQuestions.map(question => <QuestionWrapper key={question.json.name} question={question} visible={question.visible}/>)}
