...
export default class QuestionPanelDynamic extends React.Component {
    ...
    renderPanel(key) {
        ...
        {panelCount > minPanelCount && (<TouchableWithFeedback onPress={() => this.onPanelRemoveButtonClicked(key)}>
    ...
    render() {
        ...
        {maxPanelCount > panelCount && (<TouchableWithFeedback onPress={this.onNewPanel}>
